# `ng-fiddle` demo projects

> This folder contains two demo-projects (`esm` and `umd` folders) for [ng-fiddle](https://github.com/iwannabebot/ng-fiddle). These demo projects may help you to test whether your library supports AOT/JIT/UMD builds or not.
>
...
```bash
# Assuming the you are already in ng-fiddle/demo folder
...
- `ng-fiddle/demo/esm/dist/jit/index.html` file for JIT build
- `ng-fiddle/demo/esm/dist/aot/index.html` file for AOT build
- `ng-fiddle/demo/umd/index.html` file for UMD build
...
This command may be used simultaneously in combination with [ng-fiddle](https://github.com/iwannabebot/ng-fiddle)'s `yarn build:watch`. As a result once you change library source code it will be automatically re-compiled and in turn your JIT demo-project will be automatically re-built and you will be able to see that changes in your browser instantly. 
